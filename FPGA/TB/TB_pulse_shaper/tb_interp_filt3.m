...
if analyseFile
 disp('Analysing file');
 hw_dout_filename = 'Z:/XTX/FPGA/PRJ/pulse_shaper/solution1/csim/build/rtl_dout.dat';
 hw_dout = dlmread(hw_dout_filename,',');
 hw_y = complex(hw_dout(:,1), hw_dout(:,2))/16384;   % output is in 2.14 format.
end
